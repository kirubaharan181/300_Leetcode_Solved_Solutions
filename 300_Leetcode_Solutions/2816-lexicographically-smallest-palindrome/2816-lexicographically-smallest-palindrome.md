<h1>2816 - Lexicographically Smallest Palindrome</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/lexicographically-smallest-palindrome/">lexicographically-smallest-palindrome</a></h2><p>You are given a string <code node="[object Object]">s</code> consisting of <strong>lowercase English letters</strong>, and you are allowed to perform operations on it. In one operation, you can <strong>replace</strong> a character in <code node="[object Object]">s</code> with another lowercase English letter.</p>
