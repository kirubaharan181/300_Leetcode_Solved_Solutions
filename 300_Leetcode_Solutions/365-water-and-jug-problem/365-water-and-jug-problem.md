<h1>365 - Water and Jug Problem</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/water-and-jug-problem/">water-and-jug-problem</a></h2><p>You are given two jugs with capacities <code>x</code> liters and <code>y</code> liters. You have an infinite water supply. Return whether the total amount of water in both jugs may reach <code>target</code> using the following operations:</p>
