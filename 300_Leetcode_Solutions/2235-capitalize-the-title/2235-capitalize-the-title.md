<h1>2235 - Capitalize the Title</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/capitalize-the-title/">capitalize-the-title</a></h2><p>You are given a string <code>title</code> consisting of one or more words separated by a single space, where each word consists of English letters. <strong>Capitalize</strong> the string by changing the capitalization of each word such that:</p>
